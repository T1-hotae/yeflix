// E2E 테스트 전역 상수 (playwright.config.mjs / 헬퍼 / 스펙에서 공유)
...
export const FIREBASE_PROJECT_ID = 'demo-yeflix';

export const APP_PORT = Number(process.env.E2E_PORT ?? 3100);
export const BASE_URL = `http://${EMULATOR_HOST}:${APP_PORT}`;

export const AUTH_EMULATOR_URL = `http://${EMULATOR_HOST}:${AUTH_EMULATOR_PORT}`;
export const FIRESTORE_EMULATOR_URL = `http://${EMULATOR_HOST}:${FIRESTORE_EMULATOR_PORT}`;
